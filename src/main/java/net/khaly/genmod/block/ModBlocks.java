package net.khaly.genmod.block;

import net.khaly.genmod.McGenMod;
import net.khaly.genmod.block.custom.SpeedyBlock;
import net.khaly.genmod.item.ModCreativeModeTab;
import net.khaly.genmod.item.ModItems;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
                DeferredRegister.create(ForgeRegistries.BLOCKS, McGenMod.MOD_ID);
    ...
    public static final RegistryObject<Block> SPEEDY_BLOCK = registerBlock("speedy_block",
            () -> new SpeedyBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(4f).requiresCorrectToolForDrops()), ModCreativeModeTab.MOD_TAB, "tooltip.block.speedy_block");
    ...
    public static final RegistryObject<Block> COBALT_BUTTON = registerBlock("cobalt_button",
            () -> new StoneButtonBlock(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(4f).requiresCorrectToolForDrops().noCollission()), ModCreativeModeTab.MOD_TAB);
    ...
    public static final RegistryObject<Block> COBALT_FENCE_GAT = registerBlock("cobalt_fence_gate",
    ...
    public static final RegistryObject<Block> CHERRY_BLOSSOM_DOOR = registerBlock("cherry_blossom_door",
            () -> new WallBlock(BlockBehaviour.Properties.of(Material.WOOD)
                    .strength(4f).requiresCorrectToolForDrops().noOcclusion()), ModCreativeModeTab.MOD_TAB);
